...
public:
    ...
    Q_INVOKABLE void getStations(const QString &url = QString());
    Q_INVOKABLE void searchStations(const QString &query);
    Q_INVOKABLE void getStationsByGenre(const QString &genre);
    Q_INVOKABLE void getStationsByCountry(const QString &country);
    Q_INVOKABLE void getStationsByLanguage(const QString &language);
    Q_INVOKABLE void getMyStations();
    Q_INVOKABLE void getFavouriteStations();
    Q_INVOKABLE void getRecentlyPlayedStations();
