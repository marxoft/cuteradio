    ...
    Flickable {
        ...
        Column {
            ...
            Label {
                ...
                wrapMode: Text.WordWrap
                font.pixelSize: UI.FONT_SMALL
                text: qsTr("Bitrate") + ": " + (player.metaData.audioBitRate ? Utils.formatBytes(player.metaData.audioBitRate) + "/s"
                                                                             : qsTr("Unknown"))
            }
        }
    }
    ...
    Column {
        ...
        /*MyProgressBar {
            ...
            SeekBubble {
                ...
                opacity: value != "" ? 1 : 0
                value: (seekMouseArea.drag.active) && (seekMouseArea.posInsideDragArea) ? Utils.formatMSecs(Math.floor((seekMouseArea.mouseX / seekMouseArea.width) * player.duration)) : ""
            }
        ...
        Row {
            Label {
                ...
                font.pixelSize: UI.FONT_SMALL
                text: Utils.formatMSecs(player.position)
            }
